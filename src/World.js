...
export default class World {
    ...
    _setupWorld(mainObject) {
        ...
        this.camera.position.set( 50.0, 30, 30 );
        this.camera.layers.enableAll();
        this.scene.add(this.camera);

        this.spotLight = new THREE.SpotLight( 0xffffff, Math.PI * 1000.0 );
        this.spotLight.angle = Math.PI / 5;
        this.spotLight.penumbra = 0.2;
        this.spotLight.position.set( -20, 30, -30 );
        ...
        this.helper = new THREE.GridHelper( 200, 20 );
        this.helper.material.opacity = 1.0;
        this.helper.material.transparent = true;
        this.helper.position.set(0, 0.05, 0);
        ...
        this.renderer.setPixelRatio( window.devicePixelRatio * this.mobile ? 0.5 : 1 );
